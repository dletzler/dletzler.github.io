...
#Get descriptions, clean, and set up word frequency
...
#Convert to three sentiment columns: space/positive/about-town
...
#Try basic Naive Bayes on overall word frequency in descriptions
library(tm)
library(SnowballC)
